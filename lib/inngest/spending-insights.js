...
import { callDeepSeekViaOpenRouter } from "@/lib/callDeepSeekViaOpenRouter";
...
5. Recommendations for Next Month
      ...
      try {
        const htmlBody = await step.run(`DeepSeek AI · ${user._id}`, () =>
          callDeepSeekViaOpenRouter(prompt, process.env.OPENROUTER_API_KEY)
        );
